...
public class MailUtility {
    ...
    public boolean sendMail(String name,String email,String password) throws MessagingException, UnsupportedEncodingException {
        ...
        String href = "http://localhost:8081/WEIBlog_war_exploded/User/activateUser?&email="+email;
...
//                "\t\t\t\t<tr><td><b style=\"text-decoration: underline;\">"+href+"</b></td></tr>\n" +
    ...
    public static void main(String[] args) throws MessagingException, UnsupportedEncodingException {
        ...
        m.sendMail("123","1090409167@qq.com","123");
    }
}
