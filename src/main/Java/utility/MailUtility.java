...
public class MailUtility {
    ...
    public boolean sendMail(String name,String email,String password) throws MessagingException {
        ...
        String href = "http://localhost:8080/WEIBlog_war_exploded/User/addUser?name="+name+"&email="+email+"&password="+password;
        ...
        // 设置发件人（账号）
        msg.setFrom(new InternetAddress("13168034666@sohu.com"));

        Transport transport = session.getTransport();
        // 连接邮件服务器(账号，授权码)
        transport.connect("13168034666@sohu.com", "PQX8R9C1KV");
        // 发送邮件
    ...
    public static void main(String[] args) throws MessagingException {
        ...
        m.sendMail("123","13168034666@sohu.com","123");
    }
}
